...
export const LogProgress: React.FC<LogProgressProps> = ({
    ...
    const handleLogProgress = useCallback((progresss, descriptionn, datee) => {
        if (progresss !== "" && descriptionn !== "") {
            ...
            Alert.alert(
                "Please fill out both progress and description fields."
            );
        }
    }, []);
    ...
    return (
        <View style={styles.container}>
            ...
            >
                {" "}
                Enter your progress in terms of {metricValue}{" "}
            </Text>
            <TextInput
            ...
            <TouchableOpacity
                ...
                onPress={useCallback(
                    () => handleLogProgress(progresss, descriptionn, datee),
                    [progresss, descriptionn, datee]
                )}
                underlayColor="#fff"
            >
                <Text style={styles.logProgressText}>
                    Take a photo to log it!
                </Text>
            </TouchableOpacity>
        </View>
    );
